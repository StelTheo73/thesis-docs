...
6. Το παιχνίδι είχε θετική επίδραση στη διατήρηση της γνώσης, όπως προκύπτει από τα αποτελέσματα της επανάληψης του Post Test. Η μέση βαθμολογία του επαναληπτικού Post Test ήταν <>%, σημαντικά υψηλότερη από τη μέση βαθμολογία στο Pre Test (17%).
