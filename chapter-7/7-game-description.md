...
<!-- Step 1: October - November 7: Game level design, definition of levels, project setup, experiments with qartvm lirbary -->
<!-- Step 2: November 7 - December 5: home, levels and spaceships screen, level selection, demo game, 1st round of testing -->
<!-- Step 3: December 12 -  December 18: Add pause menu, tutorial overlay and help -->
<!-- Step 4: December 20: Localization -->
<!-- Step 5: December 21 - December 31: Quiz screen + tutorial -->
<!-- Step 6: January 1 - January 4: Bug fixes -->
...
Στην αξιολόγηση του παιχνιδιού, η οποία έγινε σε δύο φάσεις, συμμετείχαν εθελοντικά 8 άτομα. Επιλέχθηκαν 8 φοιτητές Πανεπιστημίου, οι οποίοι δήλωσαν ότι έχουν γνώση προχωρημένων μαθηματικών και δεν έχουν ενασχόληση με το αντικείμενο των κβαντικών υπολογιστών. Τέσσερεις από αυτού είχαν γνώση μιγαδικών αριθμών.
